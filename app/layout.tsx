...
export const metadata: Metadata = {
  ...
  description:
    "창원개인회생, 창원개인파산 전문 법무법인. 창원지방법원 도보 1분, 9,375명 채무 해결. 80~90% 빚 탕감, 5일 내 독촉 중단, 1% 이내 기각률. 상담 예약 1577-1291",
  keywords: "창원개인회생, 창원개인파산, 창원회생, 창원파산, 경남개인회생, 경남개인파산, 개인회생, 개인파산, 채무조정, 빚탕감, 법무법인, 김앤파트너스",
  openGraph: {
    title: "창원개인회생 창원개인파산 전문 | 법무법인 김앤파트너스",
    description: "창원개인회생, 창원개인파산 전문 법무법인. 창원지방법원 도보 1분, 9,375명 채무 해결. 80~90% 빚 탕감, 상담 예약 1577-1291",
    type: "website",
    locale: "ko_KR",
